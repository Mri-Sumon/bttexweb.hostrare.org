...
@section('content')
<!-- Start Slider Area -->
<?php $sliders=\App\Medias::where('link_id','slider')->get();
$counter=1;
$counter1=1;
?>
@if(count($sliders)>0)
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        ...
        <img src="{{URL::to('/')}}/application/storage/app/{{$slider->source}}" alt="" title="#slider-direction-{{$counter}}" />
        <?php $counter++;?>
        @endforeach
      </div>
      ...
      <!-- direction 1 -->
      @foreach($sliders as $slider)
      <div id="slider-direction-{{$counter1}}" class="slider-direction slider-one">
        <div class="container">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">{{$slider->name}} </h2>
                </div>
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">{{$slider->sec_title}}</h1>
                </div>
                <!-- layer 3 -->
  ...
  <!-- Start Service area -->
  <div id="services" class="services-area area-padding hidden">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="our-skill-area fix hidden-sm hidden">
  ...
  <!-- Faq area start -->
  <div class="faq-area area-padding hidden">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
  ...
  <!--              <h2>Welcome To Sajib Enterprise</h2>-->
  <!--              <p>-->
...
<?php /*
        ...
        <div class="team-top">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{URL::to('/')}}/assets/img/team/1.jpg" alt="">
									</a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{URL::to('/')}}/assets/img/team/2.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{URL::to('/')}}/assets/img/team/3.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{URL::to('/')}}/assets/img/team/4.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
  ...
  <div class="reviews-area hidden-xs">
    <div class="work-us">
      <div class="work-left-text">
        <a href="#">
						<img src="{{URL::to('/')}}/assets/img/about/2.jpg" alt="">
					</a>
      </div>
              ...
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{URL::to('/')}}/assets/img/portfolio/1.jpg">
                      <h4>Business City</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{URL::to('/')}}/assets/img/portfolio/2.jpg">
                      <h4>Blue Sea</h4>
                      <span>Photosho</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{URL::to('/')}}/assets/img/portfolio/3.jpg">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{URL::to('/')}}/assets/img/portfolio/4.jpg">
                      <h4>Creative Team</h4>
                      <span>Web design</span>
                    </a>
                  </div>
            ...
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{URL::to('/')}}/assets/img/portfolio/5.jpg">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{URL::to('/')}}/assets/img/portfolio/6.jpg">
                      <h4>Night Hill</h4>
                      <span>Photoshop</span>
                    </a>
                  </div>
  ...
  <!-- start pricing area -->
  <div id="pricing" class="pricing-area area-padding hidden">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              <div class="single-blog-img">
                <a href="blog.html">
										<img src="{{URL::to('/')}}/assets/img/blog/3.jpg" alt="">
									</a>
              </div>
              <div class="blog-meta">
                <span class="comments-type">

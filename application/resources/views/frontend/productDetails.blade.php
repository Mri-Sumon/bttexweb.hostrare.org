...
<div class="row" style="margin-top:5px; margin-left: 5%; margin-right: 5%;">
    <div class="col-12 col-lg-2 col-md-2 card categories" style="background-color: E7EDEC;">
        <h3 style="font-family: oswald;">Product Categories</h1>
        <?php $cats=\DB::table('cats')->where('parent','0')->get();?>
                        <nav class="nav2 categories">
                            <ul>
                                @foreach($cats as $cat)
    ...
    <div class="col-12 col-lg-10 col-md-10 mb-5 slidersAndBanners1" style="margin-padding: 15px !important;">
        <div class="row">
            <div class="col-12 col-lg-6 col-md-6 sliders">
                <?php $ppics=explode(',',$product_details->pics);?>
                <div class="slider-for row p-3 sliders" style="height: 578px !important;">
            ...
            <div class="col-12 col-lg-6 col-md-6 p-3 banners1">
            ...
            <!--<div class="related_products">-->
                ...
                <div class="row mt-4">
                    @foreach($rps as $rp)
                    <div class="col-2 card related_products">

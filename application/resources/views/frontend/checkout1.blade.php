...
<section class="content_wrapper checkout_wrapper">
        <div class="container ">
        	<form action="{{ URL::to('confirm-order') }}" method="post" class="calculate-shipping">
        	   @csrf
        	    <div class="row">
	                    ...
	                    <div class="checkout_details">
                            ...
                            <div class="col-sm-12" style="margin-bottom:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="right" style="margin-left:106px;margin-top: -26px;">
	                    ...
	                    <div class="cart-total">
	                        ...
	                        <div class="checkout_item_wrap">
                                ...
                                @foreach(Cart::content() as $item)
	                            	<div class="checkout_item_info">
	                                    <div class="item_name">
	                                        <p><span>1.</span>{{$item->model->name}}</p>
	                                    </div>
	                                    <div class="item_qty">
	                                        <p>{{$item->qty}}</p>
	                                    </div>
	                        ...
	                        <div class="block block-subtotal">
	                            <div class="subtotal v2 d-flex align-items-center justify-content-end">
	                                ...
	                                <div class="price">৳ <span >{{Cart::subtotal()}}</span></div>
	                            </div>
                                <div class="subtotal v2 d-flex align-items-center justify-content-end">
	                                <div class="label h6">Tax</div>
	                                <div class="tax">৳ {{Cart::tax()}}</div>
	                            ...
	                            <div class="total v2 d-flex align-items-center justify-content-end">
	                                ...
	                                <div class="price" id="GrandOrderTk">৳ <span id="grand-total">{{Cart::total()}}</span></div>
	                           </div>
...
.checkout_payment li:hover{
    background-color:transparent;
	                        ...
	                        <div class="checkout-actions mar-top-30">
	                            ...
	                            <!---<a hre="#" class="btn btn-primary" type="submit">Submit</a>--->
	                        </div>
	                    </div>
	                </div>
            	</div>

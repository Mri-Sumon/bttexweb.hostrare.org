...
class MainController extends Controller
{
     ...
     public function home()
    {
        ...
        $slider=Slider::all();
        //$pageContent=Pages::where('slug','home')->first();
        return view('frontend.home')->with('settings', $settings)->with('slider',$slider)->with('products', $products)->with('category',$category)->with('hot_product_1', $hot_product_1)->with('hot_product_2', $hot_product_2);
    }

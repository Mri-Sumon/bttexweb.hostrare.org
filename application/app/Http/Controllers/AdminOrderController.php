...
class AdminOrderController extends Controller
{
    ...
    public function showOrderDetails(){
        ...
        return view('order-item')->with('orderdetails',$orderdetails);
    }
    public function shippingDifferent(){
        $shippingdifferent=Shipping::orderBy('id','DESC')->get();
        return view('shipping-different')->with('shippingdifferent',$shippingdifferent);
    }
    ...
    public function viewdetails($id){
        $order=Order::find($id);
        return view('admin-view-order-details')->with('order',$order);
    }

!(function () {
    ...
    (function () {
        (window.SPR = (function () {
            ...
            return (
                (n.shop = Shopify.shop),
                (n.host = window.SPRSettings.apiHost),
                (n.version = "v4"),
                ...
                (n.initDomEls = function () {
                    return (
                        (this.badgeEls = this.$(".shopify-product-reviews-badge[data-id]")),
                    ...
                    return this.$.each(
                        ...
                        function (e, t) {
                            ...
                            if (((r = i.$(t).attr("data-id")), "false" !== i.$(t).attr("data-autoload")))
                                return (
                                    (a = i.$.extend({ product_id: r, version: i.version }, i.extraAjaxParams)),
                ...
                (n.toggleReviews = function (e) {
                    return this.$("#shopify-product-reviews[data-id='" + e + "']")
                        .find(".spr-reviews")
                        .toggle();
                }),
                ...
                (n.formCallback = function (e) {
                    ...
                    return (
                        ...
                        "success" === i && (n.$("#shopify-product-reviews[data-id='" + a + "'] .spr-summary-actions-newreview").hide(), n.$(".spr-form-message-success").focus()),
                ...
                (n.loadjQuery = function (e) {
                    return n.loadScript("//ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js", function () {

(() => {
    var e,
        ...
        r = {
            935: (e, t, n) => {
                "use strict";
                n.r(t), n.d(t, { getCLS: () => B, getFCP: () => g, getFID: () => S, getLCP: () => T, getTTFB: () => C });
                var r,
                    i,
                    o,
                    a,
                    ...
                    b = function () {
                        if (i >= 0 && i < o - y) {
                            var e = { entryType: "first-input", name: r.type, target: r.target, cancelable: r.cancelable, startTime: r.timeStamp, processingStart: r.timeStamp + i };
    ...
    (o.d = (e, t) => {
            ...
            (BOOMR_start = new Date().getTime()),
                ...
                (function (t) {
                    var n,
                        ...
                        u = t;
                    if (
                        (t.parent !== t && document.getElementById("boomr-if-as") && "script" === document.getElementById("boomr-if-as").nodeName.toLowerCase() && (t = t.parent),
                        (i = t.document),
                        t.BOOMR || (t.BOOMR = {}),
                        (BOOMR = t.BOOMR),
                        !BOOMR.version)
                        ...
                        if (
                            ...
                            void 0 !== i.hidden
                                ...
                                : void 0 !== i.webkitHidden && ((s = "webkitVisibilityState"), (c = "webkitvisibilitychange")),
                            (n = {
                                beacon_url: "",
                                ...
                                fireEvent: function (e, t) {
                                    ...
                                    if (((e = e.toLowerCase()), this.translate_events[e] && (e = this.translate_events[e]), this.events.hasOwnProperty(e))) {
                                        for (this.public_events.hasOwnProperty(e) && a(this.public_events[e], t), i = this.events[e], "before_beacon" !== e && "beacon" !== e && BOOMR.real_sendBeacon(), o = i.length, n = 0; n < o; n++)
                                            try {
                            ...
                            (r = {
                                ...
                                session: { domain: n.site_domain, ID: void 0, start: void 0, length: 0, enabled: !0 },
                                utils: {
                                            ...
                                            for (r in e)
                                                Object.prototype.hasOwnProperty.call(e, r) &&
                                                    (n > 0 && null !== e[r] && "object" == typeof e[r]
                                                        ? i.push(encodeURIComponent(r) + "=" + this.objectToString(e[r], t + ("\n\t" === t ? "\t" : ""), n - 1))
                                                        : "&" === t
                                    ...
                                    getSameSiteAttributeParts: function () {
                                        ...
                                        return (
                                            ...
                                            "LAX" === e
                                                ? ["SameSite=Lax"]
                                                : "NONE" === e
                                                ? "https:" === location.protocol && this.isCurrentUASameSiteNoneCompatible()
                                    ...
                                    setLocalStorage: function (e, r, i) {
                                        ...
                                        if (((o = { items: r }), "number" == typeof i && (o.expires = BOOMR.now() + 1e3 * i), (a = t.JSON.stringify(o)).length < 5e4)) {
                                            try {
                                    ...
                                    arrayFilter: function (e, t) {
                                        ...
                                        else for (var r, i = -1, o = e.length; ++i < o; ) t((r = e[i]), i, e) && (n[n.length] = r);
                                        return n;
                                    },
                                    arrayFind: function (e, t) {
                                        if ((this.isArray(e) || (e && "number" == typeof e.length)) && "function" == typeof t) {
                                            ...
                                            for (var n, r = -1, i = e.length; ++r < i; ) if (t((n = e[r]), r, e)) return n;
                                        }
                                    },
                                    ...
                                    addObserver: function (e, n, r, i, o, a) {
                                        ...
                                        function d(e) {
                                            ...
                                            u.timer && (clearTimeout(u.timer), (u.timer = null)),
                                                ...
                                                !t && u.observer && (u.observer.disconnect(), (u.observer = null)),
                                    ...
                                    addListener: function (e, t, r, i) {
                                        var o = !1;
                                        e.addEventListener
                                            ? ("object" == typeof i ? (o = i) : "boolean" == typeof i && i && BOOMR.browser.supportsPassive() && (o = { capture: !1, passive: !0 }), e.addEventListener(t, r, o))
                                    ...
                                    removeListener: function (e, t, r) {
                                        if ((e.removeEventListener ? e.removeEventListener(t, r, !1) : e.detachEvent && e.detachEvent("on" + t, r), n.listenerCallbacks.hasOwnProperty(t)))
                                            for (var i = 0; i < n.listenerCallbacks[t].length; i++) if (r === n.listenerCallbacks[t][i].fn && e === n.listenerCallbacks[t][i].el) return void n.listenerCallbacks[t].splice(i, 1);
                                    },
                                    isArray: function (e) {
                                        ...
                                        return (
                                            e
                                                ? "function" == typeof t.pageXOffset
                                                    ...
                                                    : ((r.x = t.pageXOffset), (r.y = t.pageYOffset))
                                                : n
                                                ? ((r.x = t.document.documentElement.scrollLeft), (r.y = t.document.documentElement.scrollTop))
                                                : ((r.x = t.document.body.scrollLeft), (r.y = t.document.body.scrollTop)),
                                    ...
                                    isUASameSiteNoneCompatible: function (e) {
                                        ...
                                        return (t = e.match(/(Macintosh;.*Mac OS X 10_14[_\d]*.*) AppleWebKit\//))
                                            ? !(
                                                  ((t = e.match(/Version\/.* Safari\//)) && null === (t = e.match(/Chrom(?:e|ium)/))) ||
                                                  (t = e.match(/^Mozilla\/\d+(?:\.\d+)* \(Macintosh;.*Mac OS X \d+(?:_\d+)*\) AppleWebKit\/\d+(?:\.\d+)* \(KHTML, like Gecko\)$/))
                                              )
                                ...
                                init: function (r) {
                                    ...
                                    for (a in (void 0 !== r.site_domain && (/:/.test(r.site_domain) && (r.site_domain = t.location.hostname.toLowerCase()), (this.session.domain = r.site_domain)),
                                    ...
                                    return (
                                        ((!n.handlers_attached && !r.wait) || (n.handlers_attached && n.waiting_for_config)) &&
                                            (n.onloadfired || (void 0 !== n.autorun && !1 === n.autorun) || (BOOMR.hasBrowserOnloadFired() && (BOOMR.loadedLate = !0), BOOMR.attach_page_ready(BOOMR.page_ready_autorun)),
                                ...
                                page_ready: function (e, r) {
                                    ...
                                    return (
                                        ...
                                        e || (e = { name: "load" }),
                                        r
                                            ? "number" == typeof t.BOOMR_page_ready && ((e.timing = e.timing || {}), (e.timing.loadEventEnd = t.BOOMR_page_ready), BOOMR.addVar("pr", 1, !0))
                                            : ((e.timing = e.timing || {}),
                                              ...
                                              BOOMR.addVar("pr", 1, !0)),
                                        n.onloadfired || (n.fireEvent("page_ready", e), (n.onloadfired = !0)),
                                        this
                                    );
                                },
                                ...
                                setImmediate: function (e, n, r, i) {
                                    ...
                                    (o = function () {
                                        ...
                                        t.requestIdleCallback ? t.requestIdleCallback(o, { timeout: 1e3 }) : t.setImmediate ? t.setImmediate(o) : setTimeout(o, 10);
                                },
                                now:
                                    Date.now ||
                                    function () {
                                ...
                                subscribe: function (e, r, i, o, a) {
                                    ...
                                    return (
                                        u.push({ fn: r, cb_data: i || {}, scope: o || null, once: a || !1 }),
                                ...
                                addError: function (e, t, r) {
                                    ...
                                    if (a && "" !== a && "about:blank" !== a && s && !/applebot/.test(s)) {
                                        if ((BOOMR.error("Boomerang caught error: " + e + ", src: " + t + ", extra: " + r), BOOMR.window.XMLHttpRequest)) {
                                            var c = t,
                                                u = { file: "shopify-boomerang-1.0.0.min.js", lineNumber: 1, method: t };
                                            if (e.stack) {
                                            ...
                                            l.open("POST", "https://notify.bugsnag.com/", !0),
                                                ...
                                                l.send(
                                                    JSON.stringify({
                                                        ...
                                                        payloadVersion: 5,
                                                        notifier: { name: "Native JS XHR", version: "2.3.2", url: "-" },
                                                        events: [
                                                            {
                                                                exceptions: [{ errorClass: c, stacktrace: [u], type: "browserjs" }],
                                                                app: { releaseStage: "production", version: "2.3.2", id: "shopify-boomerang-1.0.0.min.js" },
                                                                metaData: { user: { shopUrl: a, userAgent: s } },
                                                                unhandled: !1,
                                                            },
                                                        ],
                                                    })
                                        ...
                                        o && o.is_supported()
                                            ? "string" == typeof e
                                                ? o.send({ message: e, extra: r, functionName: t, noStack: !0 }, o.VIA_APP, o.SOURCE_BOOMERANG)
                                                : ("string" == typeof t && (e.functionName = t), void 0 !== r && (e.extra = r), o.send(e, o.VIA_APP, o.SOURCE_BOOMERANG))
                                            : ("string" != typeof e && ((i = String(e)).match(/^\[object/) && (i = e.name + ": " + (e.description || e.message).replace(/\r\n$/, "")), (e = i)),
                                ...
                                responseEnd: function (e, t, r, i) {
                                    if (((t = "number" == typeof t ? t : BOOMR.now()), (i = "number" == typeof i ? i : BOOMR.now()), BOOMR.readyToSend()))
                                        if (BOOMR.hasSentPageLoadBeacon() || BOOMR.utils.inArray(e.initiator, BOOMR.constants.BEACON_TYPE_SPAS))
                                            ...
                                            } else BOOMR.real_sendBeacon(), BOOMR.plugins.RT.startTimer("xhr_" + e, t), n.fireEvent("xhr_load", { name: "xhr_" + e, data: r, timing: { loadEventEnd: i } });
                                        else
                                            BOOMR.subscribe(
                                                "page_load_beacon",
                                                function () {
                                ...
                                sendBeaconData: function (e) {
                                    var r,
                                        ...
                                        c = [],
                                        u = !0;
                                    if (((n.beacon_url = n.beacon_url_override || n.beacon_url), !n.beacon_url)) return n.fireEvent("beacon_no_url", e), !1;
                                    ...
                                    if (
                                        ...
                                        "GET" === n.beacon_type
                                            ...
                                            : ("POST" === n.beacon_type || o.length > BOOMR.constants.MAX_GET_LENGTH) && (u = !1),
                                        t &&
                                            t.navigator &&
                                        ...
                                        var d = new t.Blob([i + "&sb=1"], { type: "application/x-www-form-urlencoded" });
                                        try {
                        ...
                        delete BOOMR_start,
                            ...
                            "object" == typeof console && void 0 !== console.log ? (r.log = function (e, t, n) {}) : (r.log = function () {}),
                            (l = function (e) {
                                return function (t, n) {
        ...
        (function () {
            ...
            var e = {
                ...
                onPerformanceObserver: function (t) {
                    ...
                    e.isDone ||
                        ((e.isDone = !0), e.perfObserver.disconnect(), BOOMR.addVar("total_duration_long_tasks", e.longTasksTime, !0), BOOMR.addVar("number_long_tasks", e.longTasks.length, !0), e.isCompleteCalled && BOOMR.sendBeacon());
                },
            };
        ...
        (function () {
            if (((BOOMR = window.BOOMR || {}), (BOOMR.plugins = BOOMR.plugins || {}), !BOOMR.plugins.PaintTiming)) {
                var e = { "first-paint": "first_paint", "first-contentful-paint": "first_contentful_paint", "largest-contentful-paint": "largest_contentful_paint" },
                    t = {
                        initialized: !1,
                        complete: !1,
                        supported: null,
                        ...
                        externalMetrics: {},
                            ...
                            if ((i = BOOMR.getPerformance()) && "function" == typeof i.getEntriesByType) {
                                if ((o = i.getEntriesByType("paint")) && o.length) {
                                    for (BOOMR.info("This user agent supports PaintTiming", "pt"), a = 0; a < o.length; a++)
                                        (t.timingCache[o[a].name] = o[a].startTime), e[o[a].name] && BOOMR.addVar(e[o[a].name], Math.floor(o[a].startTime), !0);
                ...
                BOOMR.plugins.PaintTiming = {
                    init: function () {
                        return (
                            ...
                            t.complete || "hidden" !== BOOMR.visibilityState() || (BOOMR.addVar("paint_timing_hidden", 1, !0), (t.complete = !0)),
                            t.initialized ||
                                ...
                                "function" == typeof BOOMR.window.PerformanceObserver &&
                                    ...
                                    ((t.observer = new BOOMR.window.PerformanceObserver(t.onObserver)), t.observer.observe({ type: "largest-contentful-paint", buffered: !0 })),
                                (t.initialized = !0)),
                            this
                        );
                    },
                    ...
                    getTimingFor: function (e) {
                        ...
                        if (this.is_supported() && (i = BOOMR.getPerformance()) && "function" == typeof i.getEntriesByType && (n = i.getEntriesByType("paint")) && n.length)
                            for (r = 0; r < n.length; r++) if (n[r].name === e) return (t.timingCache[e] = n[r].startTime), t.timingCache[e];
                    },
                        ...
                        if (t && "spa_hard" === t.initiator) e.done(t);
                            ...
                            if (t) {
                                if ((t.data && (t = t.data), (n = BOOMR.getPerformance()) && t.restiming))
                                    ...
                                    o))
                                        o.hasOwnProperty(i) && o[i] && ((o[i] += n.timing.navigationStart), (o[i] = Math.floor(o[i])));
                                for (i in (t.timing &&
                                    ((r = t.timing),
                        ...
                        if (((e.addedVars = []), (n = BOOMR.getPerformance()))) {
                            if (
                                ("function" == typeof n.getEntriesByType &&
                                    ((i = n.getEntriesByType("navigation")) && i.length ? (BOOMR.info("This user agent supports NavigationTiming2", "nt"), (i = i[0]), (s = n.timing ? n.timing.navigationStart : 0)) : (i = void 0)),
                                !i && n.timing && (BOOMR.info("This user agent supports NavigationTiming", "nt"), (i = n.timing)),
                                i &&
                                    (!(a = {
                                    ...
                                    (i.decodedBodySize || i.transferSize) && ((a.encoded_body_size = i.encodedBodySize), (a.decoded_body_size = i.decodedBodySize), (a.transfer_size = i.transferSize)),
                            ...
                            BOOMR.addVar(a),
                                i &&
                                    ((i.requestStart && i.navigationStart && i.requestStart < i.navigationStart) ||
                                        (i.responseStart && i.navigationStart && i.responseStart < i.navigationStart) ||
                                        (i.responseStart && i.fetchStart && i.responseStart < i.fetchStart) ||
                                        (i.navigationStart && i.fetchStart < i.navigationStart) ||
                                        (i.responseEnd && i.responseEnd > BOOMR.now() + 864e5)) &&
                                    (BOOMR.addVar("navigation_bad", 1), e.addedVars.push("navigation_bad"));
                            try {
        ...
        (function () {
            var e,
                t = { type: "connection_type", effectiveType: "effective_type", saveData: "save_data" };
            function n() {
                var n;
            ...
            (BOOMR = window.BOOMR || {}),
                "function" == typeof BOOMR.addVar &&
                    ("object" == typeof navigator && (e = navigator.connection || navigator.mozConnection || navigator.webkitConnection || navigator.msConnection),
                    e &&
                        (e.addEventListener &&
        ...
        (function () {
            ...
            function o(t, n) {
                ...
                for (r in t) {
                    ...
                    if (t.hasOwnProperty(r))
                        for (s = t[r], c = n ? [(c = o.split("/"))[0] + "//", c[2] + (c.length > 3 ? "/" : "")].concat(c.slice(3).reduce(p(c.length - 4), [])) : o.split(""), d = f, a = 0; a < c.length; a++)
                            void 0 === (l = d[(u = c[a])]) ? (d = d[u] = a === c.length - 1 ? s : {}) : "string" == typeof l ? (d = d[u] = { "|": l }) : a === c.length - 1 ? (d[u]["|"] = s) : (d = d[u]);
                }
                return f;
            }
            function a(e, t) {
                ...
                return 1 === s ? (t ? (((o = {})[n] = e[n]), o) : { name: n, value: e[n] }) : !!t && e;
            }
            function s(e) {
            ...
            function l(t, i, o, a, c) {
                ...
                try {
                    ...
                    if (
                        ...
                        (R = (function (t, n) {
                            var r,
                                ...
                                s = a.createElement("A");
                            return (
                                (r = (n = n || [0, 0, 0, 0])[3] + (void 0 !== t.pageXOffset) ? t.pageXOffset : (a.documentElement || a.body.parentNode || a.body).scrollLeft),
                                ...
                                ["img", "iframe", "image"].forEach(function (t) {
                                    ...
                                    for (c = 0; c < O.length; c++)
                                        if (
                                            (n = O[c]) &&
                                            ((d = n.currentSrc || n.src || ("function" == typeof n.getAttribute && n.getAttribute("src")) || n.getAttribute("xlink:href")),
                                            (s.href = d),
                                            ...
                                            e.getSrcsetDimensions && n.currentSrc && (n.srcset || (n.parentNode && n.parentNode.nodeName && "PICTURE" === n.parentNode.nodeName.toUpperCase()))
                                                ? ((l = n.isConnected ? n.ownerDocument.createElement("IMG") : new BOOMR.window.Image()).src = d)
                                                : (l = n),
                    ...
                    i &&
                        ((O = t.performance.getEntriesByType("navigation")) && 1 === O.length
                            ? ((B = O[0]),
                              w.push({
                    ...
                    for (p = 0; C && p < C.length; p++)
                        if (((_ = C[p]), !(P >= 10 && s(_)))) {
                            y = {
                                ...
                                latestTime: ((M = _), M.responseEnd ? M.responseEnd : M.responseStart && M.startTime ? M.responseStart + 0.2 * (M.responseStart - M.startTime) : 1 / 0),
                            };
                            for (var k = 0; k < r.length; k++) {
                                var L = r[k];
                                y[L] = "startTime" === L || _[L] ? _[L] + o : 0;
                            }
                            if ((_.hasOwnProperty("_data") && (y._data = _._data), ("script" === _.initiatorType || "link" === _.initiatorType) && S[_.name])) {
                                var A = S[_.name];
                                for (y.scriptAttrs = (A.async ? 1 : 0) | (A.defer ? 2 : 0); 1 === A.nodeType && "BODY" !== A.nodeName; ) A = A.parentNode;
                                y.scriptAttrs |= "BODY" === A.nodeName ? 4 : 0;
                            }
                            "link" === _.initiatorType &&
                                E[_.name] &&
                                BOOMR.utils.arrayFind(E[_.name].rel.split(/[\u0009\u000A\u000C\u000D\u0020]+/), function (e) {
                                    if (((e = e.toLowerCase()), n[e])) return (y.linkAttrs = n[e]), !0;
                                }),
                                x.push(y),
                                s(y) && P++;
                        }
            ...
            function O(e, t, n) {
                ...
                for (r = 0; r < o.length; r++)
                    if (
                        (0 === (i = o[r]).name.indexOf("http:") || 0 === i.name.indexOf("https:")) &&
                        !(
                            i.name.indexOf(BOOMR.url) > -1 ||
                            i.name.indexOf(BOOMR.config_url) > -1 ||
                            ("function" == typeof BOOMR.getBeaconURL && BOOMR.getBeaconURL() && i.name.indexOf(BOOMR.getBeaconURL()) > -1) ||
                            (e && a + i.startTime < e)
                        )
                    ) {
            ...
            function g(n, r) {
                ...
                for (i = 0; i < R.length; i++) {
                    ...
                    var b =
                        ...
                        (h = void 0),
                        (B = void 0),
                        (g = s).encodedBodySize || g.decodedBodySize || g.transferSize ? ((v = g.transferSize), [(h = g.encodedBodySize), v ? v - h : "_", (B = g.decodedBodySize) ? B - h : 0].map(p).join(",").replace(/,+$/, "")) : "");
                    if (
                        ("" !== b && (l += "*1" + b),
                        s.hasOwnProperty("scriptAttrs") && (l += "*2" + s.scriptAttrs),
                        s.hasOwnProperty("linkAttrs") && (l += "*4" + s.linkAttrs),
                        s.workerStart && "number" == typeof s.workerStart && 0 !== s.workerStart && (l += "*6" + p(c(("number" != typeof (f = s.workerStart) && (f = 0), Math.ceil(f || 0)), s.startTime))),
                    ...
                    } else void 0 !== _[d] ? (_[d] += "|" + l) : s.visibleDimensions ? (_[d] = "*0" + s.visibleDimensions.map(Math.round).map(p).join(",").replace(/,+$/, "") + "|" + l) : (_[d] = l);
                    s.visibleDimensions && (y[s.latestTime] || (y[s.latestTime] = []), y[s.latestTime].push(s.visibleDimensions));
                }
            ...
            function v(e) {
                ...
                for (var n = 0; n < e.length; n++) {
                    var r = e[n];
                    (n !== e.length - 1 && r.fetchStart === e[n + 1].fetchStart) || t.push({ fetchStart: r.fetchStart, responseEnd: r.responseStart || r.responseEnd });
                }
                return t;
            }
            function h(e, t) {
            ...
            var e = {
                setShopifyIdentifiers: function () {
                    var t =
                        ...
                        BOOMR.window.ShopifyAnalytics.lib.trekkie.defaultAttributes.visitToken;
                    if ((t && BOOMR.addVar("session_token", t), BOOMR.themeId && BOOMR.shopId))
                        BOOMR.addVar("theme_id", BOOMR.themeId.toString()),
                            ...
                            BOOMR.themeName && BOOMR.themeVersion && (BOOMR.addVar("theme_name", BOOMR.themeName.toString()), BOOMR.addVar("theme_version", BOOMR.themeVersion.toString())),
                            BOOMR.renderRegion && BOOMR.addVar("render_region", BOOMR.renderRegion.toString());
                    else {
                        var n = { shopId: "shop_id", themeId: "theme_id", application: "application", themeName: "theme_name", themeVersion: "theme_version", renderRegion: "render_region" },
                            r = BOOMR.url;
            ...
            if (((BOOMR = window.BOOMR || {}), (BOOMR.plugins = BOOMR.plugins || {}), !BOOMR.plugins.MonorailProducer)) {
                var e = {
                    ...
                    onBeacon: function (t) {
                        BOOMR.window || window;
                        var r,
                            i = { schema_id: "boomerang_real_user_measurement_audit/7.1", payload: t, metadata: { event_created_at_ms: n, event_sent_at_ms: new Date().getTime() } };
                        if (
                            window &&
                            window.navigator &&
                            ...
                            (!(r = window.navigator.userAgent) || (-1 === r.lastIndexOf("iPhone; CPU iPhone OS 12_") && -1 === r.lastIndexOf("iPad; CPU OS 12_")))
                        ) {
                            var o = new window.Blob([JSON.stringify(i)], { type: "text/plain" });
                            try {
